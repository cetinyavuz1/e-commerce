        ...
        <>
            <div className="flex flex-col items-center py-15 bg-[#ededed]">
                ...
                <div className="pt-10 flex flex-col gap-10 lg:flex lg:flex-row lg:w-[90vw] lg:justify-center">
                    <div className="bg-[url('/public/assets/productcard1/productcard1-1.jpg')] bg-cover h-[60vh] w-[80vw] flex items-end justify-start lg:w-[30vw]">
                        <p className="text-[#252b42] font-bold bg-white w-40 h-10 flex items-center justify-center mb-7 ml-7">MEN</p>
                    </div>
                    <div className="bg-[url('/public/assets/productcard1/productcard1-2.jpg')] bg-cover h-[60vh] w-[80vw] flex items-end justify-start lg:w-[15vw]">
                    ...
                    <div className="flex flex-col gap-10 lg:w-[15vw] lg:gap-[2vh]">
                        <div className="bg-[url('/public/assets/productcard1/productcard1-3.jpg')] bg-cover h-[30vh] w-[80vw] flex items-end justify-start lg:w-[15vw] lg:h-[29vh]">
                            <p className="text-[#252b42] font-bold bg-white w-40 h-10 flex items-center justify-center mb-7 ml-7">ACCESSORIES</p>
                        </div>
                        <div className="bg-[url('/public/assets/productcard1/productcard1-4.jpg')] bg-cover h-[30vh] w-[80vw] flex items-end justify-start lg:w-[15vw] lg:h-[29vh]">
